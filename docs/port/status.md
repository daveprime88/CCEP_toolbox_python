...
Updated 9 September 2026. This is a working development port, **not the complete
...
| --- | --- | --- |
| WP1 | Concise README/illustrated guide, complete manual transcription and six original images; 543-file hash inventory, 101 source candidates and 36 capability groups; typed package, Ruff/Black/Pyright, pre-commit and CI | Execute remote OS matrix; final asset/runtime dependency audit |
...
| WP3b | Strict geometry, endpoint interpolation, SPM-style absolute pull evaluation, ANTs registration, six-prior segmentation and sphere-warp centroid candidates; executed synthetic ANTs tests | Matched SPM corpus, calibrated scientific criteria, normalization/template choices, atlas/tissue shape sampling, legacy imaging session adapters, manual reorientation and full viewers; ANTsPy Python 3.14 installation/build |
...
| WP6 | One authoritative Codex playbook shipped in the package; discovery/install commands; executable end-to-end command and failure tests | Live agent-assisted researcher walkthrough and complete first-release scientific operations |

## Evidence and limits

- macOS arm64 Python 3.11.15: **58 tests pass**, including Qt and ANTsPy 0.6.3.
  Ruff, Black and Pyright pass in this full environment.
- macOS arm64 Python 3.14.6: **55 tests pass**, one ANTs test module is skipped.
...
- CI definitions exist but have not been run on GitHub. Core CI resolves without
  the imaging extra; the integrated 3.11 job uses the full lock.
...
- Wheel and source distributions build successfully. The noneditable wheel was
